...
public class ContentPaneEx extends JFrame {
	public ContentPaneEx() {
		...
		contentPane.setBackground(Color.ORANGE); // 컨텐트 배경색을 오렌지색으로
		contentPane.sdtLayout(new FlowLayout()); // 컨텐트ㅡ에 FlowLayout 배치관리자 달기
		...
		setSize(200, 150); // 프레임 크기 300x150 설정
		sdtVisible(true); // 화면에 프레임 출력
	}
