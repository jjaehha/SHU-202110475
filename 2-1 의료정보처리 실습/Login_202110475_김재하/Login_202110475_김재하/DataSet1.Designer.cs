...
namespace Login_202110475_김재하.DataSet1TableAdapters {
...
SELECT ID, Name, Department, Title, Password FROM Employee WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=kcesoft.co.kr,1227;Initial Catalog=ocsdb;Persist Security Info=True;U" +
                "ser ID=danuser01;Password=Baebk@921";
        }
        ...
        public virtual DataSet1.EmployeeDataTable GetDataBy(string ID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((ID == null)) {
                throw new global::System.ArgumentNullException("ID");
            }
